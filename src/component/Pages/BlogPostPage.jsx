      ...
      <div className='flex items-center justify-center flex-col'>
        ...
        {blogList.length>0 ?(
          ...
          <button
            ...
            className={`px-4 py-2 mx-1 rounded-sm ${currentPage === 1 ? 'bg-gray-300 text-gray-600 cursor-not-allowed' : 'bg-gray-200'}`}
          ...
          <button
            onClick={() => paginate(currentPage + 1)}
            className={`px-4 py-2 mx-1 rounded-sm  ${currentPage === totalPages ? 'bg-gray-300 text-gray-600 cursor-not-allowed' : 'bg-gray-200'}`}
